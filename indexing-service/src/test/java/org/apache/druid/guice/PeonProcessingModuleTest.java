...
public class PeonProcessingModuleTest
{
  ...
  public void testConfigBuilder()
  {
    final PeonProcessingModule.Config config = new PeonProcessingModule.Config()
        ...
        .withMergeBuffers();
    JUnit5Assertions.assertTrue(config.hasProcessingBuffers());
    JUnit5Assertions.assertTrue(config.hasProcessingThreads());
    JUnit5Assertions.assertTrue(config.hasMergeBuffers());
  }
  ...
  public void testGetProcessingExecutorPool_whenNotNeeded()
  {
    ...
    JUnit5Assertions.assertSame(NoopQueryProcessingPool.instance(), pool);
  }
  ...
  public void testGetIntermediateResultsPool_whenNotNeeded()
  {
    ...
    JUnit5Assertions.assertSame(DummyNonBlockingPool.instance(), pool);
  }
  ...
  public void testGetMergeBufferPool_whenNotNeeded()
  {
    ...
    JUnit5Assertions.assertSame(DummyBlockingPool.instance(), pool);
  }

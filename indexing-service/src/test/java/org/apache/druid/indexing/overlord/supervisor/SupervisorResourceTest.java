...
public class SupervisorResourceTest extends EasyMockSupport
{
  ...
  public void testSpecPost()
  {
    ...
    JUnit5Assertions.assertEquals(Map.of("id", "my-id", "modified", true, "restarted", true), response.getEntity());
    resetAll();
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(Map.of("id", "my-id", "modified", false, "restarted", true), response.getEntity());
    resetAll();
  ...
  public void testSpecPost_returnsBadRequest_whenValidateSpecThrows()
  {
    ...
    JUnit5Assertions.assertEquals(ImmutableMap.of("error", "nope"), response.getEntity());
  }
  ...
  public void testSpecPost_whenSkipRestartIfUnmodifiedIsTrue()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(Map.of("id", "my-id", "modified", true, "restarted", false), response.getEntity());
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(Map.of("id", "my-id", "modified", false, "restarted", false), response.getEntity());
  ...
  public void testSpecPostWithInputSourceSecurityEnabledUnauthorized()
  {
    ...
    JUnit5Assertions.assertThrows(ForbiddenException.class, () -> supervisorResource.specPost(spec, false, request));
    JUnit5Assertions.assertThrows(ForbiddenException.class, () -> supervisorResource.specPost(spec, null, request));
    verifyAll();
  }
  ...
  public void testSpecGetAll()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(SUPERVISOR_IDS, response.getEntity());
    resetAll();
  ...
  public void testSpecGetAllWithPartialAuthorizationForReadAccess()
  {
    ...
    JUnit5Assertions.assertEquals(ImmutableSet.of("id1"), returnedIds);
  }
  ...
  public void testSpecGetAllSystem()
  {
    ...
    JUnit5Assertions.assertEquals(2, specs.size());
    SupervisorStatus spec = specs.get(0);
    JUnit5Assertions.assertEquals(spec.getId(), "id1");
    JUnit5Assertions.assertEquals(spec.getState(), "RUNNING");
    JUnit5Assertions.assertEquals(spec.getDetailedState(), "RUNNING");
    JUnit5Assertions.assertEquals(true, spec.isHealthy());
    JUnit5Assertions.assertEquals(spec.getSpecString(), "{\"type\":\"SupervisorResourceTest$TestSupervisorSpec\"}");
    JUnit5Assertions.assertEquals(spec.getType(), "test");
    JUnit5Assertions.assertEquals(spec.getSource(), "dummy");
    JUnit5Assertions.assertEquals(false, spec.isSuspended());
  }
  ...
  public void testSpecGet()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(spec, response.getEntity());
  ...
  public void testSpecGetStatus()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(report, response.getEntity());
  ...
  public void testSpecGetHealth()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(ImmutableMap.of("healthy", true), response.getEntity());

    response = supervisorResource.specGetHealth("my-id-2");

    JUnit5Assertions.assertEquals(503, response.getStatus());
    JUnit5Assertions.assertEquals(ImmutableMap.of("healthy", false), response.getEntity());
  ...
  public void testSpecSuspend()
  {
    ...
    JUnit5Assertions.assertEquals(suspended.id, responseSpec.id);
    JUnit5Assertions.assertEquals(suspended.suspended, responseSpec.suspended);
    resetAll();
    ...
    JUnit5Assertions.assertEquals(400, response.getStatus());
    JUnit5Assertions.assertEquals(ImmutableMap.of("error", "[my-id] is already suspended"), response.getEntity());
  }
  ...
  public void testSpecResume()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    TestSupervisorSpec responseSpec = (TestSupervisorSpec) response.getEntity();
    JUnit5Assertions.assertEquals(running.id, responseSpec.id);
    JUnit5Assertions.assertEquals(running.suspended, responseSpec.suspended);
    resetAll();
    ...
    JUnit5Assertions.assertEquals(400, response.getStatus());
    JUnit5Assertions.assertEquals(ImmutableMap.of("error", "[my-id] is already running"), response.getEntity());
  }
  ...
  public void testTerminate()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(ImmutableMap.of("id", "my-id"), response.getEntity());
  ...
  public void testSuspendAll()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(ImmutableMap.of("status", "success"), response.getEntity());
    verifyAll();
  }
  ...
  public void testSpecGetAllHistory()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(history, response.getEntity());
  ...
  public void testSpecGetAllHistoryWithPartialAuthorization()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(filteredHistory, response.getEntity());
  ...
  public void testSpecGetHistory()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(versions1, response.getEntity());

    response = supervisorResource.specGetHistory(request, "id2", null);

    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(versions2, response.getEntity());
  ...
  public void testSpecGetHistoryWithLimit()
  {
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(limitedVersions, response.getEntity());
    ...
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(versions, response.getEntity());
  ...
  public void testReset()
  {
    ...
    JUnit5Assertions.assertEquals(404, response.getStatus());
    JUnit5Assertions.assertEquals(id1.getValue(), "my-id");
    JUnit5Assertions.assertEquals(id2.getValue(), "my-id-2");
    verifyAll();
  ...
  public void testNoopSupervisorSpecSerde() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(expectedSpec, deserializedSpec);
    ...
    JUnit5Assertions.assertEquals(spec, specRoundTrip);
  }
  ...
  public void testSpecPostMergeUsesExistingTaskCountWhenNewSpecHasNone()
  {
    ...
    JUnit5Assertions.assertEquals(5, newSpec.getIoConfig().getTaskCount());
  }
  ...
  public void testSpecPostMergeUsesProvidedTaskCountOverExistingTaskCount()
  {
    ...
    JUnit5Assertions.assertEquals(3, newSpec.getIoConfig().getTaskCount());
  }
  ...
  public void testSpecPostMergeCarriesForwardEvenWhenExistingHasOnlyTaskCountMin()
  {
    ...
    JUnit5Assertions.assertEquals(1, existingSpec.getIoConfig().getTaskCount());
    JUnit5Assertions.assertEquals(4, newSpec.getIoConfig().getTaskCount());

    newSpec.merge(existingSpec);

    JUnit5Assertions.assertEquals(1, newSpec.getIoConfig().getTaskCount());
  }
  ...
  public void test_handoffTaskGroups_returnsAccepted()
  {
    ...
    JUnit5Assertions.assertEquals(202, response.getStatus());
    JUnit5Assertions.assertNull(response.getEntity());

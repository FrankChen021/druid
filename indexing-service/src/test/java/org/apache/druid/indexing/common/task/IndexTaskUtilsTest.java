...
public class IndexTaskUtilsTest
{
  ...
  public void testSetTaskDimensionsWithContextTagsShouldSetTags()
  {
    ...
    JUnit5Assertions.assertEquals(METRIC_TAGS, metricBuilder.getDimension(DruidMetrics.TAGS));
  }
  ...
  public void testSetTaskDimensionsWithoutTagsShouldNotSetTags()
  {
    ...
    IndexTaskUtils.setTaskDimensions(metricBuilder, task);
    JUnit5Assertions.assertNull(metricBuilder.getDimension(DruidMetrics.TAGS));
  }
  ...
  {
    IndexTaskUtils.setTaskDimensions(metricBuilder, task);
    JUnit5Assertions.assertEquals(GROUP_ID, metricBuilder.getDimension(DruidMetrics.GROUP_ID));
  }
  ...
  public void testSetTaskDimensionsForAbstractTaskWithoutGroupIdShouldNotSetGroupId()
  {
    ...
    IndexTaskUtils.setTaskDimensions(metricBuilder, abstractTask);
    JUnit5Assertions.assertNull(metricBuilder.getDimension(DruidMetrics.GROUP_ID));
  }
}

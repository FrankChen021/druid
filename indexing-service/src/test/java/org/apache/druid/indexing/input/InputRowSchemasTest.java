...
public class InputRowSchemasTest extends InitializedNullHandlingTest
{
  ...
  public void testFromDataSchema()
  {
    ...
    JUnit5Assertions.assertEquals(timestampSpec, inputRowSchema.getTimestampSpec());
    JUnit5Assertions.assertEquals(dimensionsSpec.getDimensions(), inputRowSchema.getDimensionsSpec().getDimensions());
    JUnit5Assertions.assertEquals(dimensionsSpec.getDimensionNames(), inputRowSchema.getDimensionsSpec().getDimensionNames());
    JUnit5Assertions.assertEquals(ImmutableSet.of("count", "met"), inputRowSchema.getMetricNames());
  }
  ...
  public void testFromDataSchemaWithNoAggregator()
  {
    ...
    JUnit5Assertions.assertEquals(dimensionsSpec.getDimensions(), inputRowSchema.getDimensionsSpec().getDimensions());
    JUnit5Assertions.assertEquals(dimensionsSpec.getDimensionNames(), inputRowSchema.getDimensionsSpec().getDimensionNames());
    JUnit5Assertions.assertEquals(ImmutableSet.of(), inputRowSchema.getMetricNames());
  }
}

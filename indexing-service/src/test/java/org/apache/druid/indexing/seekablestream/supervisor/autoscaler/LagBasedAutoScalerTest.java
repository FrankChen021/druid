...
public class LagBasedAutoScalerTest
{
  ...
  public void testScaleOutDoesNotReturnCountBelowTaskCountMin()
  {
    ...
    JUnit5Assertions.assertEquals(54, createAutoScaler().computeDesiredTaskCount(createLagSamples(2_000_001L)));
  }
  ...
  public void testReturnsUnclampedScaleOutStepEvenWhenCurrentIsBelowMin()
  {
    ...
    JUnit5Assertions.assertEquals(5, createAutoScaler().computeDesiredTaskCount(createLagSamples(2_000_001L)));
  }
  ...
  public void testReturnsUnclampedScaleInStepEvenWhenCurrentIsAboveMax()
  {
    ...
    JUnit5Assertions.assertEquals(100, createAutoScaler().computeDesiredTaskCount(createLagSamples(299_999L)));
  }

...
public class MinorCompactionInputSpecTest
{
  ...
  public void testSerde() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(spec, deserialized);
    JUnit5Assertions.assertEquals(interval, deserialized.getInterval());
    JUnit5Assertions.assertEquals(segments, deserialized.getSegments());
  }
  ...
  public void testDeserializeFromClientFormat() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(Intervals.of("2015-04-11/2015-04-12"), deserialized.getInterval());
    JUnit5Assertions.assertEquals(1, deserialized.getSegments().size());
  ...
  public void testThrowsExceptionWhenInvalidInterval()
  {
    ...
    JUnit5Assertions.assertThrows(DruidException.class, () -> new MinorCompactionInputSpec(null, segments));

    Interval emptyInterval = Intervals.of("2015-04-11/2015-04-11");
    JUnit5Assertions.assertThrows(DruidException.class, () -> new MinorCompactionInputSpec(emptyInterval, segments));
  }
  ...
  {
    Interval interval = Intervals.of("2015-04-11/2015-04-12");
    JUnit5Assertions.assertThrows(DruidException.class, () -> new MinorCompactionInputSpec(interval, null));
    JUnit5Assertions.assertThrows(DruidException.class, () -> new MinorCompactionInputSpec(interval, List.of()));
  }
  ...
  public void testThrowsExceptionWhenSegmentsOutsideInterval()
  {
    ...
    JUnit5Assertions.assertThrows(DruidException.class, () -> new MinorCompactionInputSpec(interval, segments));
  }
}

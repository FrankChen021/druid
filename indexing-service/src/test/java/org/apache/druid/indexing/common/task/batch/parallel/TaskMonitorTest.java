...
public class TaskMonitorTest
{
  ...
  public void testBasic() throws InterruptedException, ExecutionException, TimeoutException
  {
    ...
    for (int i = 0; i < futures.size(); i++) {
      ...
      JUnit5Assertions.assertEquals(result.getSpec().getSupervisorTaskId(), "supervisorId");
      JUnit5Assertions.assertEquals(result.getSpec().getId(), "specId" + i);
      JUnit5Assertions.assertNotNull(result.getLastStatus());
      JUnit5Assertions.assertEquals(TaskState.SUCCESS, result.getLastStatus().getStatusCode());
      JUnit5Assertions.assertEquals(TaskState.SUCCESS, result.getLastState());
    }
  }
  ...
  public void testRetry() throws InterruptedException, ExecutionException, TimeoutException
  {
    ...
    for (int i = 0; i < futures.size(); i++) {
      ...
      JUnit5Assertions.assertNotNull(taskHistory);

      final List<TaskStatusPlus> attemptHistory = taskHistory.getAttemptHistory();
      JUnit5Assertions.assertNotNull(attemptHistory);
      JUnit5Assertions.assertEquals(3, attemptHistory.size());
      JUnit5Assertions.assertEquals(TaskState.FAILED, attemptHistory.get(0).getStatusCode());
      JUnit5Assertions.assertEquals(TaskState.FAILED, attemptHistory.get(1).getStatusCode());
    }
  }
  ...
  public void testResubmitWithOldType() throws InterruptedException, ExecutionException, TimeoutException
  {
    ...
    for (int i = 0; i < futures.size(); i++) {
      ...
      final List<TaskStatusPlus> attemptHistory = taskHistory.getAttemptHistory();
      JUnit5Assertions.assertNotNull(attemptHistory);
      JUnit5Assertions.assertEquals(1, attemptHistory.size());
      JUnit5Assertions.assertEquals(TaskState.SUCCESS, attemptHistory.get(0).getStatusCode());
    }
  }
  ...
  public void testTimeout() throws InterruptedException, ExecutionException, TimeoutException
  {
    ...
    JUnit5Assertions.assertNotNull(result.getLastStatus());
    JUnit5Assertions.assertEquals(TaskState.FAILED, result.getLastStatus().getStatusCode());
    JUnit5Assertions.assertEquals(TaskState.FAILED, result.getLastState());
    timeoutMonitor.stop();
  }

...
public class SegmentAllocateActionTest
{
  ...
  public void testManySegmentsSameInterval_noLineageCheck() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(expectedIds, allocatedIds);
  }
  ...
  public void testManySegmentsSameInterval()
  {
    ...
    if (lockGranularity == LockGranularity.TIME_CHUNK) {
      ...
      JUnit5Assertions.assertEquals(3, partyTimeLocks.size());
  ...
  public void testResumeSequence()
  {
    ...
    JUnit5Assertions.assertNotNull(id1);
    ...
    JUnit5Assertions.assertNotNull(id2);
    ...
    JUnit5Assertions.assertNotNull(id3);
    ...
    JUnit5Assertions.assertNull(id4);
    ...
    JUnit5Assertions.assertNotNull(id5);
    ...
    JUnit5Assertions.assertNull(id6);
    ...
    JUnit5Assertions.assertNotNull(id7);
    ...
    if (lockGranularity == LockGranularity.TIME_CHUNK) {
      ...
      JUnit5Assertions.assertEquals(2, partyLocks.size());
      final Map<Integer, SegmentLock> partitionIdToLock = new HashMap<>();
      partyLocks.forEach(lock -> {
        JUnit5Assertions.assertEquals(LockGranularity.SEGMENT, lock.getGranularity());
      ...
      JUnit5Assertions.assertEquals(1, futureLocks.size());
  ...
  public void testSegmentIsAllocatedForLatestUsedSegmentVersion()
  {
    ...
    JUnit5Assertions.assertEquals(segmentV1.getVersion(), pendingSegmentV11.getVersion());

    JUnit5Assertions.assertNotEquals(pendingSegmentV01, pendingSegmentV11);
    ...
    JUnit5Assertions.assertTrue(segmentV2.getVersion().compareTo(segmentV1.getVersion()) > 0);
    ...
    JUnit5Assertions.assertEquals(segmentV2.getVersion(), pendingSegmentV21.getVersion());

    JUnit5Assertions.assertNotEquals(pendingSegmentV21, pendingSegmentV01);
    JUnit5Assertions.assertNotEquals(pendingSegmentV21, pendingSegmentV11);
  }
  ...
  public void testMultipleSequences()
  {
    ...
    if (lockGranularity == LockGranularity.TIME_CHUNK) {
      ...
      JUnit5Assertions.assertEquals(3, partyLocks.size());
      ...
      JUnit5Assertions.assertEquals(2, futureLocks.size());
  ...
  public void testCannotAddToExistingNumberedShardSpecsWithCoarserQueryGranularity()
  {
    ...
    JUnit5Assertions.assertNull(id1);
  }
  ...
  public void testWithPartialShardSpecAndOvershadowingSegments()
  {
    ...
    JUnit5Assertions.assertNotNull(segmentIdentifier);

    final ShardSpec shardSpec = segmentIdentifier.getShardSpec();
    JUnit5Assertions.assertEquals(2, shardSpec.getPartitionNum());

    JUnit5Assertions.assertTrue(shardSpec instanceof HashBasedNumberedShardSpec);
    final HashBasedNumberedShardSpec hashBasedNumberedShardSpec = (HashBasedNumberedShardSpec) shardSpec;
    JUnit5Assertions.assertEquals(2, hashBasedNumberedShardSpec.getNumCorePartitions());
    JUnit5Assertions.assertEquals(ImmutableList.of("dim1"), hashBasedNumberedShardSpec.getPartitionDimensions());
  }
  ...
  public void testAllocateAllGranularity()
  {
    ...
    JUnit5Assertions.assertNotNull(id1);
    JUnit5Assertions.assertNotNull(id2);
    JUnit5Assertions.assertEquals(Intervals.ETERNITY, id1.getInterval());
    JUnit5Assertions.assertEquals(Intervals.ETERNITY, id2.getInterval());
  }
  ...
  public void testAllocateWeekOnlyWhenWeekIsPreferred()
  {
    ...
    JUnit5Assertions.assertNotNull(id1);
    JUnit5Assertions.assertNotNull(id2);
    JUnit5Assertions.assertEquals(Duration.ofHours(1).toMillis(), id1.getInterval().toDurationMillis());
    JUnit5Assertions.assertEquals(Duration.ofDays(7).toMillis(), id2.getInterval().toDurationMillis());
  }
  ...
  public void testAllocateDayWhenMonthNotPossible()
  {
    ...
    JUnit5Assertions.assertNotNull(id2);
    JUnit5Assertions.assertEquals(Duration.ofHours(1).toMillis(), id1.getInterval().toDurationMillis());
    JUnit5Assertions.assertEquals(Duration.ofDays(1).toMillis(), id2.getInterval().toDurationMillis());
  }
  ...
  public void testSegmentIdMustNotBeReused()
  {
    ...
    JUnit5Assertions.assertNull(coordinator.retrieveSegmentForId(theId.asSegmentId()));
  ...
  private void assertSameIdentifier(final SegmentIdWithShardSpec expected, final SegmentIdWithShardSpec actual)
  {
    ...
    JUnit5Assertions.assertEquals(expected.getShardSpec(), actual.getShardSpec());
  }

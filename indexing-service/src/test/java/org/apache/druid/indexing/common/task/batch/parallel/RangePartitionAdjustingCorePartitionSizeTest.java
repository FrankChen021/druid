...
public class RangePartitionAdjustingCorePartitionSizeTest extends AbstractMultiPhaseParallelIndexingTest
{
  ...
  public void testLessPartitionsThanBuckets() throws IOException
  {
    ...
    JUnit5Assertions.assertEquals(1, shardSpec.getNumCorePartitions());
    JUnit5Assertions.assertEquals(0, shardSpec.getPartitionNum());
    JUnit5Assertions.assertEquals(partitionDimensions, shardSpec.getDimensions());
  }
  ...
  public void testEqualNumberOfPartitionsToBuckets() throws IOException
  {
    ...
    segments.forEach(segment -> {
      ...
      JUnit5Assertions.assertTrue(shardSpec.getPartitionNum() < shardSpec.getNumCorePartitions());
      JUnit5Assertions.assertEquals(partitionDimensions, shardSpec.getDimensions());
    });
  }
}

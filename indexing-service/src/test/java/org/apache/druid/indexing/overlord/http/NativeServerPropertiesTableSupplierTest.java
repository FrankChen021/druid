...
public class NativeServerPropertiesTableSupplierTest
{
  ...
  public void testReturnsVisiblePropertiesAndNodeMetadata()
  {
    ...
    final NativeServerPropertiesTableSupplier supplier = supplier(properties, allowAllAuthorizerMapper());
  ...
  {
    final NativeServerPropertiesTableSupplier supplier = supplier(new Properties(), allowAllAuthorizerMapper());
  ...
  public void testRejectsUnauthorizedRequest()
  {
    ...
    final NativeServerPropertiesTableSupplier supplier = supplier(new Properties(), authorizerMapper);
  ...
  private static NativeServerPropertiesTableSupplier supplier(
      final Properties properties,
      final AuthorizerMapper authorizerMapper
  )
  {
    return new NativeServerPropertiesTableSupplier(

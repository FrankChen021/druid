...
public class LagBasedAutoScalerConfigTest
{
  ...
  public void testDefaults()
  {
    ...
    JUnit5Assertions.assertEquals(30000, config.getLagCollectionIntervalMillis());
    JUnit5Assertions.assertEquals(600000, config.getLagCollectionRangeMillis());
    JUnit5Assertions.assertEquals(300000, config.getScaleActionStartDelayMillis());
    JUnit5Assertions.assertEquals(60000, config.getScaleActionPeriodMillis());
    JUnit5Assertions.assertEquals(6000000, config.getScaleOutThreshold());
    JUnit5Assertions.assertEquals(1000000, config.getScaleInThreshold());
    JUnit5Assertions.assertEquals(0.3, config.getTriggerScaleOutFractionThreshold(), 0.00001);
    JUnit5Assertions.assertEquals(0.9, config.getTriggerScaleInFractionThreshold(), 0.00001);
    JUnit5Assertions.assertEquals(1, config.getScaleInStep());
    JUnit5Assertions.assertEquals(2, config.getScaleOutStep());
    JUnit5Assertions.assertEquals(600000, config.getMinTriggerScaleActionFrequencyMillis());
    // When minScaleUpDelay/minScaleDownDelay are not set, they fall back to minTriggerScaleActionFrequencyMillis
    JUnit5Assertions.assertEquals(Duration.millis(600000), config.getMinScaleUpDelay());
    JUnit5Assertions.assertEquals(Duration.millis(600000), config.getMinScaleDownDelay());
    JUnit5Assertions.assertNull(config.getLagAggregate());
  ...
  public void testSerde() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(config1, config2);
  }
  ...
  public void testEnabledTaskCountChecks()
  {
    ...
    RuntimeException ex1 = JUnit5Assertions.assertThrows(
    ...
    JUnit5Assertions.assertTrue(ex1.getMessage().contains("taskCountMax or taskCountMin can't be null"));

    // Should throw if taskCountMax < taskCountMin
    RuntimeException ex2 = JUnit5Assertions.assertThrows(
        RuntimeException.class,
        () ->
            new LagBasedAutoScalerConfig(
                null,
    ...
    JUnit5Assertions.assertTrue(ex2.getMessage().contains("taskCountMax can't lower than taskCountMin"));

    // Should throw if taskCountStart out of range
    RuntimeException ex3 = JUnit5Assertions.assertThrows(
        RuntimeException.class,
        () ->
            new LagBasedAutoScalerConfig(
                null,
    ...
    JUnit5Assertions.assertTrue(ex3.getMessage().contains("taskCountMin <= taskCountStart <= taskCountMax"));
  }
  ...
  public void testStopTaskCountRatioBounds()
  {
    ...
    IllegalArgumentException ex1 = JUnit5Assertions.assertThrows(
    ...
    JUnit5Assertions.assertTrue(ex1.getMessage().contains("0.0 < stopTaskCountRatio <= 1.0"));

    // Fail if stopTaskCountRatio < 0
    IllegalArgumentException ex2 = JUnit5Assertions.assertThrows(
        IllegalArgumentException.class,
        () -> new LagBasedAutoScalerConfig(
            null,
            null,
    ...
    JUnit5Assertions.assertTrue(ex2.getMessage().contains("0.0 < stopTaskCountRatio <= 1.0"));

    // Fail if stopTaskCountRatio > 1.0
    IllegalArgumentException ex3 = JUnit5Assertions.assertThrows(
        IllegalArgumentException.class,
        () -> new LagBasedAutoScalerConfig(
            null,
            null,
    ...
    JUnit5Assertions.assertTrue(ex3.getMessage().contains("0.0 < stopTaskCountRatio <= 1.0"));
    ...
    JUnit5Assertions.assertEquals(Double.valueOf(0.5), config.getStopTaskCountRatio());
  }
  ...
  public void testScaleDelayFallback() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(60000L, baseOnly.getMinTriggerScaleActionFrequencyMillis());
    JUnit5Assertions.assertEquals(Duration.millis(60000), baseOnly.getMinScaleUpDelay());
    JUnit5Assertions.assertEquals(Duration.millis(60000), baseOnly.getMinScaleDownDelay());
    ...
    JUnit5Assertions.assertEquals(Duration.millis(15000), upOnly.getMinScaleUpDelay());
    JUnit5Assertions.assertEquals(Duration.millis(60000), upOnly.getMinScaleDownDelay());
    ...
    JUnit5Assertions.assertEquals(Duration.millis(60000), downOnly.getMinScaleUpDelay());
    JUnit5Assertions.assertEquals(Duration.millis(30000), downOnly.getMinScaleDownDelay());
    ...
    JUnit5Assertions.assertEquals(Duration.millis(15000), bothSet.getMinScaleUpDelay());
    JUnit5Assertions.assertEquals(Duration.millis(30000), bothSet.getMinScaleDownDelay());
  ...
  public void testScaleDelayFallbackViaSerde() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(45000L, config.getMinTriggerScaleActionFrequencyMillis());
    JUnit5Assertions.assertEquals(Duration.millis(45000), config.getMinScaleUpDelay());
    JUnit5Assertions.assertEquals(Duration.millis(45000), config.getMinScaleDownDelay());
    ...
    JUnit5Assertions.assertEquals(Duration.standardSeconds(10), configUpOnly.getMinScaleUpDelay());
    JUnit5Assertions.assertEquals(Duration.millis(45000), configUpOnly.getMinScaleDownDelay());
  }
  ...
  public void testMinTriggerScaleActionFrequencyMillisSerdeCompat() throws Exception
  {
    ...
    // delays fall back to it.
    {
      ...
      JUnit5Assertions.assertEquals(Duration.millis(defaultMinTriggerMillis), config.getMinScaleUpDelay());
      JUnit5Assertions.assertEquals(Duration.millis(defaultMinTriggerMillis), config.getMinScaleDownDelay());
    ...
    // back to it.
    {
      ...
      JUnit5Assertions.assertEquals(900_000L, config.getMinTriggerScaleActionFrequencyMillis());
      JUnit5Assertions.assertEquals(Duration.millis(900_000), config.getMinScaleUpDelay());
      JUnit5Assertions.assertEquals(Duration.millis(900_000), config.getMinScaleDownDelay());
      assertRoundTrips(config);
    }
  ...
  public void testEqualsAndHashCode()
  {
    ...
    JUnit5Assertions.assertNotEquals(config1, config2);
    JUnit5Assertions.assertNotEquals(config1.hashCode(), config2.hashCode());
  }
}

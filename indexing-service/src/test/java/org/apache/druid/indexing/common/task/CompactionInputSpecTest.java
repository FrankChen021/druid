...
public class CompactionInputSpecTest
{
  ...
  {
    JUnit5Assertions.assertEquals(INTERVAL, inputSpec.findInterval(DATASOURCE));
  }

  @Test
  public void testValidateSegments()
  {
    JUnit5Assertions.assertTrue(inputSpec.validateSegments(LockGranularity.TIME_CHUNK, SEGMENTS));
    JUnit5Assertions.assertTrue(inputSpec.validateSegments(LockGranularity.SEGMENT, SEGMENTS));
    JUnit5Assertions.assertFalse(inputSpec.validateSegments(LockGranularity.SEGMENT, SEGMENTS.subList(0, SEGMENTS.size() - 1)));
  }
  ...
  public void testValidateWrongSegments()
  {
    ...
    JUnit5Assertions.assertFalse(inputSpec.validateSegments(LockGranularity.TIME_CHUNK, someSegmentIsMissing));
    ...
    JUnit5Assertions.assertFalse(inputSpec.validateSegments(LockGranularity.TIME_CHUNK, someSegmentIsUnknown));
  }
}

...
public class TaskLogAutoCleanerTest
{
  ...
  public void testGetSchedule()
  {
    ...
    JUnit5Assertions.assertTrue(taskLogAutoCleaner.isEnabled());

    final DutySchedule schedule = taskLogAutoCleaner.getSchedule();
    JUnit5Assertions.assertEquals(cleanerConfig.getDelay(), schedule.getPeriodMillis());
    JUnit5Assertions.assertEquals(cleanerConfig.getInitialDelay(), schedule.getInitialDelayMillis());
  }
  ...
  public void testIsEnabled()
  {
    ...
    TaskLogAutoCleaner taskLogAutoCleaner = new TaskLogAutoCleaner(null, cleanerConfig, null);
    JUnit5Assertions.assertFalse(taskLogAutoCleaner.isEnabled());
  }

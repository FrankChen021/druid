...
public class ParallelIndexSupervisorTaskResourceTest extends AbstractParallelIndexSupervisorTaskTest
{
  ...
  public void testAPIs() throws Exception
  {
    ...
    JUnit5Assertions.assertNotNull(runner, "runner is null");

    // test getMode
    Response response = task.getMode(newRequest());
    JUnit5Assertions.assertEquals(200, response.getStatus());
    JUnit5Assertions.assertEquals(response.getEntity(), "parallel");
    ...
    JUnit5Assertions.assertEquals(1, runningSpecs.size());
    ...
    JUnit5Assertions.assertEquals(1, taskHistory.size());
    ...
    JUnit5Assertions.assertEquals(2, taskHistory.size());
  ...
  )
  {
    ...
    JUnit5Assertions.assertEquals(runningTasks.size(), monitorStatus.getRunning());
    JUnit5Assertions.assertEquals(expectedSucceededTasks, monitorStatus.getSucceeded());
    JUnit5Assertions.assertEquals(expectedFailedTask, monitorStatus.getFailed());
    JUnit5Assertions.assertEquals(expectedSucceededTasks + expectedFailedTask, monitorStatus.getComplete());
    JUnit5Assertions.assertEquals(runningTasks.size() + expectedSucceededTasks + expectedFailedTask, monitorStatus.getTotal());
    ...
    JUnit5Assertions.assertEquals(completeSubTaskSpecs, actual);
    ...
    JUnit5Assertions.assertEquals(subTaskId, subTaskSpec.getId());
    ...
    JUnit5Assertions.assertEquals(expectedResponse.getSpec().getId(), actualResponse.getSpec().getId());
    JUnit5Assertions.assertEquals(expectedResponse.getCurrentStatus(), actualResponse.getCurrentStatus());
    JUnit5Assertions.assertEquals(expectedResponse.getTaskHistory(), actualResponse.getTaskHistory());

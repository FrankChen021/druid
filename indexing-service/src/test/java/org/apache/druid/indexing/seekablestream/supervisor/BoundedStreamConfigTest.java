...
public class BoundedStreamConfigTest
{
  ...
  public void testConstructorWithNullStartSequenceNumbers()
  {
    ...
    JUnit5Assertions.assertTrue(ex.getMessage().contains("cannot be null or empty"));
  }
  ...
  public void testConstructorWithMismatchedPartitions()
  {
    ...
    JUnit5Assertions.assertTrue(ex.getMessage().contains("must have matching partition sets"));
  }
  ...
  public void testSerializationDeserialization() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(2, deserialized.getStartSequenceNumbers().size());
    JUnit5Assertions.assertEquals(2, deserialized.getEndSequenceNumbers().size());
    JUnit5Assertions.assertEquals(100, deserialized.getStartSequenceNumbers().get("0"));
    JUnit5Assertions.assertEquals(200, deserialized.getStartSequenceNumbers().get("1"));
    JUnit5Assertions.assertEquals(500, deserialized.getEndSequenceNumbers().get("0"));
    JUnit5Assertions.assertEquals(600, deserialized.getEndSequenceNumbers().get("1"));
  }
  ...
  public void testDeserializationWithStringValues() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(2, config.getStartSequenceNumbers().size());
    JUnit5Assertions.assertEquals(2, config.getEndSequenceNumbers().size());
  }

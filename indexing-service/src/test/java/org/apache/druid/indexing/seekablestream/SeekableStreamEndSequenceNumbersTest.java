...
public class SeekableStreamEndSequenceNumbersTest
{
  ...
  public void testSerde() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(partitions, partitions2, "Round trip");
    ...
    JUnit5Assertions.assertEquals(stream, asMap.get("stream"));
    JUnit5Assertions.assertEquals(stream, asMap.get("topic"));
  ...
  public void testCompareToWithTrueResult()
  {
    ...
    JUnit5Assertions.assertEquals(1, partitions1.compareTo(partitions2, Comparator.naturalOrder()));
  }
  ...
  public void testCompareToWithFalseResult()
  {
    ...
    JUnit5Assertions.assertEquals(0, partitions1.compareTo(partitions2, Comparator.naturalOrder()));
  }
}

...
public class TaskLocksTest
{
  ...
  private TaskLock tryTimeChunkLock(Task task, Interval interval, TaskLockType lockType)
  {
    final TaskLock taskLock = lockbox
        ...
        .getTaskLock();
    JUnit5Assertions.assertNotNull(taskLock);
    return taskLock;
  }
  ...
  public void testCheckLockCoversSegments()
  {
    ...
    JUnit5Assertions.assertEquals(3, locks.size());
    JUnit5Assertions.assertTrue(TaskLocks.isLockCoversSegments(task, lockbox, segments));
  }
  ...
  public void testCheckLargeLockCoversSegments()
  {
    ...
    JUnit5Assertions.assertEquals(1, locks.size());
    JUnit5Assertions.assertTrue(TaskLocks.isLockCoversSegments(task, lockbox, segments));
  }
  ...
  public void testCheckLockCoversSegmentsWithOverlappedIntervals()
  {
    ...
    JUnit5Assertions.assertEquals(3, locks.size());
    JUnit5Assertions.assertFalse(TaskLocks.isLockCoversSegments(task, lockbox, segments));
  }
  ...
  public void testFindReplaceLocksCoveringSegments()
  {
    ...
    JUnit5Assertions.assertEquals(segments.size(), observedLocks.size());

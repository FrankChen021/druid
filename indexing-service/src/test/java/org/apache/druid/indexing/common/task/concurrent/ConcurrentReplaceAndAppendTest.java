...
public class ConcurrentReplaceAndAppendTest extends IngestionTestBase
{
  ...
  public void testLockReplaceAllocateAppend()
  {
    ...
    JUnit5Assertions.assertEquals(segmentV10.getVersion(), pendingSegment.getVersion());
  ...
  public void testLockAllocateAppendDayReplaceDay()
  {
    ...
    final SegmentIdWithShardSpec pendingSegment
        = appendTask.allocateSegmentForTimestamp(FIRST_OF_JAN_23.getStart(), Granularities.DAY);
    JUnit5Assertions.assertEquals(SEGMENT_V0, pendingSegment.getVersion());
  ...
  public void testLockReplaceMonthAllocateAppendDay()
  {
    ...
    final SegmentIdWithShardSpec pendingSegment
        = appendTask.allocateSegmentForTimestamp(FIRST_OF_JAN_23.getStart(), Granularities.DAY);
    JUnit5Assertions.assertEquals(JAN_23, pendingSegment.getInterval());
    JUnit5Assertions.assertEquals(v1, pendingSegment.getVersion());
  ...
  public void testLockAllocateAppendDayReplaceMonth()
  {
    ...
    final SegmentIdWithShardSpec pendingSegment
        = appendTask.allocateSegmentForTimestamp(FIRST_OF_JAN_23.getStart(), Granularities.DAY);
    JUnit5Assertions.assertEquals(FIRST_OF_JAN_23, pendingSegment.getInterval());
    JUnit5Assertions.assertEquals(SEGMENT_V0, pendingSegment.getVersion());
  ...
  public void testLockReplaceDayAllocateAppendMonth()
  {
    ...
    JUnit5Assertions.assertNull(appendLock);
  ...
  public void testAllocateLockReplaceDayAppendMonth()
  {
    ...
    JUnit5Assertions.assertNull(replaceLock);
    ...
    final ISE exception = JUnit5Assertions.assertThrows(ISE.class, () -> replaceTask.commitReplaceSegments(segmentV10));
  ...
  public void testLockReplaceQuarterAllocateAppendYear()
  {
    ...
    JUnit5Assertions.assertNotNull(replaceLock);
    ...
    JUnit5Assertions.assertEquals(JAN_FEB_MAR_23, pendingSegment.getInterval());
    JUnit5Assertions.assertEquals(replaceLock.getVersion(), pendingSegment.getVersion());
  ...
  public void testLockAllocateAppendYearReplaceQuarter()
  {
    ...
    final SegmentIdWithShardSpec pendingSegment
        = appendTask.allocateSegmentForTimestamp(YEAR_23.getStart(), Granularities.YEAR);
    JUnit5Assertions.assertEquals(YEAR_23, pendingSegment.getInterval());
    JUnit5Assertions.assertEquals(SEGMENT_V0, pendingSegment.getVersion());
  ...
  public void testLockReplaceAllocateLockReplaceLockReplaceAppend()
  {
    ...
    JUnit5Assertions.assertEquals(v1, pendingSegmentV11.getVersion());
    JUnit5Assertions.assertEquals(YEAR_23, pendingSegmentV11.getInterval());
    ...
    JUnit5Assertions.assertEquals(Sets.newHashSet(segmentV21, segmentV11), appendedSegments);
  ...
  public void testLockReplaceMultipleAppends()
  {
    ...
    final SegmentIdWithShardSpec pendingSegment2
        = appendTask.allocateSegmentForTimestamp(FIRST_OF_JAN_23.getStart(), Granularities.DAY);
    JUnit5Assertions.assertEquals(segmentV10.getVersion(), pendingSegment2.getVersion());
  ...
  public void testMultipleGranularities()
  {
    ...
    final SegmentIdWithShardSpec pendingSegment01
        = appendTask.allocateSegmentForTimestamp(FIRST_OF_JAN_23.getStart(), Granularities.DAY);
    JUnit5Assertions.assertEquals(SEGMENT_V0, pendingSegment01.getVersion());
    JUnit5Assertions.assertEquals(FIRST_OF_JAN_23, pendingSegment01.getInterval());
    ...
    JUnit5Assertions.assertEquals(SEGMENT_V0, pendingSegment02.getVersion());
    JUnit5Assertions.assertEquals(OCT_NOV_DEC_23, pendingSegment02.getInterval());
    ...
    JUnit5Assertions.assertEquals(SEGMENT_V0, pendingSegment03.getVersion());
    JUnit5Assertions.assertEquals(OCT_NOV_DEC_23, pendingSegment03.getInterval());
  ...
  public void testSegmentIsAllocatedAtLatestVersion()
  {
    final SegmentIdWithShardSpec pendingSegmentV01
        = appendTask.allocateSegmentForTimestamp(JAN_23.getStart(), Granularities.MONTH);
    JUnit5Assertions.assertEquals(SEGMENT_V0, pendingSegmentV01.getVersion());
    JUnit5Assertions.assertEquals(JAN_23, pendingSegmentV01.getInterval());
    ...
    JUnit5Assertions.assertNotNull(upgradedPendingSegments);
    ...
    final SegmentIdWithShardSpec pendingSegmentV12
        = appendTask.allocateSegmentForTimestamp(JAN_23.getStart(), Granularities.MONTH);
    JUnit5Assertions.assertNotEquals(pendingSegmentV01.asSegmentId(), pendingSegmentV12.asSegmentId());
    JUnit5Assertions.assertNotEquals(pendingSegmentV11.asSegmentId(), pendingSegmentV12.asSegmentId());
    JUnit5Assertions.assertEquals(v1, pendingSegmentV12.getVersion());
    JUnit5Assertions.assertEquals(JAN_23, pendingSegmentV12.getInterval());
    ...
    final SegmentIdWithShardSpec pendingSegmentV23
        = appendTask.allocateSegmentForTimestamp(JAN_23.getStart(), Granularities.MONTH);
    JUnit5Assertions.assertNotEquals(pendingSegmentV01.asSegmentId(), pendingSegmentV23.asSegmentId());
    JUnit5Assertions.assertEquals(v2, pendingSegmentV23.getVersion());
    JUnit5Assertions.assertEquals(JAN_23, pendingSegmentV23.getInterval());
    ...
    JUnit5Assertions.assertEquals(3 + 3, appendedSegments.size());

    // Verify that the original append segments have been committed
    JUnit5Assertions.assertTrue(appendedSegments.remove(segmentV01));
    JUnit5Assertions.assertTrue(appendedSegments.remove(segmentV12));
    JUnit5Assertions.assertTrue(appendedSegments.remove(segmentV23));
    ...
    JUnit5Assertions.assertNotNull(segmentV22);
    ...
    JUnit5Assertions.assertNull(segmentV13);
  ...
  public void testSegmentsToReplace()
  {
    ...
    final SegmentIdWithShardSpec pendingSegmentV02
        = appendTask.allocateSegmentForTimestamp(JAN_23.getStart(), Granularities.MONTH);
    JUnit5Assertions.assertNotEquals(pendingSegmentV01.asSegmentId(), pendingSegmentV02.asSegmentId());
    JUnit5Assertions.assertEquals(SEGMENT_V0, pendingSegmentV02.getVersion());
    JUnit5Assertions.assertEquals(JAN_23, pendingSegmentV02.getInterval());
    ...
    final SegmentIdWithShardSpec pendingSegmentV03
        = appendTask.allocateSegmentForTimestamp(JAN_23.getStart(), Granularities.MONTH);
    JUnit5Assertions.assertNotEquals(pendingSegmentV01.asSegmentId(), pendingSegmentV03.asSegmentId());
    JUnit5Assertions.assertNotEquals(pendingSegmentV02.asSegmentId(), pendingSegmentV03.asSegmentId());
    JUnit5Assertions.assertEquals(SEGMENT_V0, pendingSegmentV03.getVersion());
    JUnit5Assertions.assertEquals(JAN_23, pendingSegmentV03.getInterval());
  ...
  public void testLockAllocateDayReplaceMonthAllocateAppend()
  {
    ...
    final SegmentIdWithShardSpec pendingSegmentV1
        = appendTask.allocateSegmentForTimestamp(FIRST_OF_JAN_23.getStart(), Granularities.DAY);
    JUnit5Assertions.assertEquals(segmentV10.getVersion(), pendingSegmentV1.getVersion());
    ...
    JUnit5Assertions.assertEquals(3, appendSegments.size());
    // Segment V11 is committed
    JUnit5Assertions.assertTrue(appendSegments.remove(segmentV11));
    // Segment V00 is also committed
    JUnit5Assertions.assertTrue(appendSegments.remove(segmentV00));
    ...
    JUnit5Assertions.assertEquals(v1, segmentV12.getVersion());
    JUnit5Assertions.assertEquals(JAN_23, segmentV12.getInterval());
    JUnit5Assertions.assertEquals(segmentV00.getLoadSpec(), segmentV12.getLoadSpec());
  ...
  public void test_concurrentAppend_toIntervalWithUnusedAppendSegment_createsFreshVersion()
  {
    ...
    final SegmentIdWithShardSpec pendingSegment
        = appendTask.allocateSegmentForTimestamp(FIRST_OF_JAN_23.getStart(), Granularities.DAY);
    JUnit5Assertions.assertEquals(SEGMENT_V0, pendingSegment.getVersion());
    JUnit5Assertions.assertEquals(0, pendingSegment.getShardSpec().getPartitionNum());
    ...
    JUnit5Assertions.assertEquals(SEGMENT_V0 + "S", pendingSegment2.getVersion());
    JUnit5Assertions.assertEquals(0, pendingSegment2.getShardSpec().getPartitionNum());

    final DataSegment segmentV02 = asSegment(pendingSegment2);
    appendTask.commitAppendSegments(segmentV02);
    JUnit5Assertions.assertNotEquals(segmentV01, segmentV02);
  ...
  public void test_allocateCommitDelete_createsFreshVersion_uptoMaxAllowedRetries()
  {
    ...
    for (int i = 0; i < maxAllowedAppends; ++i, expectedVersion += "S") {
      ...
      JUnit5Assertions.assertEquals(expectedVersion, pendingSegment.getVersion());
      JUnit5Assertions.assertEquals(expectedParitionNum, pendingSegment.getShardSpec().getPartitionNum());
      ...
      JUnit5Assertions.assertEquals(expectedVersion, segment.getVersion());
      JUnit5Assertions.assertEquals(expectedParitionNum, segment.getShardSpec().getPartitionNum());
  ...
  public void test_concurrentReplace_onIntervalWithPendingSegment_upgradesIt()
  {
    ...
    final List<PendingSegmentRecord> upgradedPendingSegments = replacePublishResult.getUpgradedPendingSegments();
    JUnit5Assertions.assertNotNull(upgradedPendingSegments);
    JUnit5Assertions.assertEquals(1, upgradedPendingSegments.size());
    ...
    JUnit5Assertions.assertEquals(v1, upgradedPendingSegment.getId().getVersion());
  ...
  private void verifyIntervalHasPendingSegments(Interval interval, SegmentIdWithShardSpec... expectedPendingSegments)
  {
    ...
    JUnit5Assertions.assertEquals(expected, observed);
  }
  ...
  private void verifySegments(Interval interval, Segments visibility, DataSegment... expectedSegments)
  {
    try {
      ...
      JUnit5Assertions.assertEquals(Sets.newHashSet(expectedSegments), Sets.newHashSet(allUsedSegments));
    }
    catch (IOException e) {

...
public class ImmutableWorkerInfoTest
{
  ...
  public void testSerde() throws Exception
  {
    ...
    JUnit5Assertions.assertEquals(workerInfo, serde);
  }
  ...
  public void test_canRunTask()
  {
    ...
    JUnit5Assertions.assertTrue(workerInfo.canRunTask(parallelIndexTask, 0.5));

    // Since task fails the parallel slot constraint, it cannot run (3 > 1)
    JUnit5Assertions.assertFalse(workerInfo.canRunTask(parallelIndexTask, 0.1));
    ...
    JUnit5Assertions.assertFalse(workerInfo.canRunTask(anyOtherTask, 0.5));
    ...
    JUnit5Assertions.assertFalse(workerInfo.canRunTask(grp1Task, 0.3));
  }

  private void assertEqualsAndHashCode(ImmutableWorkerInfo o1, ImmutableWorkerInfo o2, boolean shouldMatch)
  {
    if (shouldMatch) {
      JUnit5Assertions.assertTrue(o1.equals(o2));
      JUnit5Assertions.assertEquals(o1.hashCode(), o2.hashCode());
    } else {
      JUnit5Assertions.assertFalse(o1.equals(o2));
      JUnit5Assertions.assertNotEquals(o1.hashCode(), o2.hashCode());
    }
  }
}

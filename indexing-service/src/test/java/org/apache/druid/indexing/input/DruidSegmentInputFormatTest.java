...
public class DruidSegmentInputFormatTest
{
  ...
  public void testDruidSegmentInputEntityReader()
  {
    ...
    JUnit5Assertions.assertTrue(reader instanceof DruidSegmentReader);
  }
  ...
  public void testDruidTombstoneSegmentInputEntityReader()
  {
    ...
    JUnit5Assertions.assertTrue(reader instanceof DruidTombstoneSegmentReader);
  }
  ...
  public void testDruidSegmentInputEntityReaderBadEntity()
  {
    ...
    JUnit5Assertions.assertEquals(expectedMessage, actualMessage);
  }
}

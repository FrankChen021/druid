...
public class GeneratorInputSourceTest
{
  ...
  public void testSerde() throws JsonProcessingException
  {
    ...
    JUnit5Assertions.assertEquals(inputSource, sauce);
  }
  ...
  public void testReader() throws IOException
  {
    ...
    JUnit5Assertions.assertEquals(generatorFirst, first);
    JUnit5Assertions.assertTrue(iterator.hasNext());
    int i;
    for (i = 1; iterator.hasNext(); i++) {
      iterator.next();
    }
    JUnit5Assertions.assertEquals(numRows, i);
  }
  ...
  public void testSplits()
  {
    ...
    JUnit5Assertions.assertEquals(2, inputSource.estimateNumSplits(null, null));
    JUnit5Assertions.assertFalse(inputSource.needsFormat());
    JUnit5Assertions.assertEquals(2, inputSource.createSplits(null, null).count());
  ...
  public void testGetTypes()
  {
    ...
    JUnit5Assertions.assertEquals(ImmutableSet.of(IndexingServiceInputSourceModule.GENERATOR_SCHEME), inputSource.getTypes());
  }
}

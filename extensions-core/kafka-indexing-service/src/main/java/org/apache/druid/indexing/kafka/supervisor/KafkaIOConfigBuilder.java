...
public class KafkaIOConfigBuilder extends SupervisorIOConfigBuilder<KafkaIOConfigBuilder, KafkaSupervisorIOConfig>
{
  ...
  public KafkaIOConfigBuilder withPollTimeout(Long pollTimeout)
  {
    this.pollTimeout = pollTimeout;
    return this;
  }

  public KafkaIOConfigBuilder withConfigOverrides(KafkaConfigOverrides configOverrides)
  {
    this.configOverrides = configOverrides;
    return this;
  }

  public KafkaIOConfigBuilder withEmitTimeLagMetrics(Boolean emitTimeLagMetrics)
  {
    this.emitTimeLagMetrics = emitTimeLagMetrics;
    return this;
  }
  ...
  /**
   * Populates this builder (base and Kafka-specific fields) from an existing config.
   */
  public KafkaIOConfigBuilder copyFrom(KafkaSupervisorIOConfig io)
  {
    copyFromBase(io);

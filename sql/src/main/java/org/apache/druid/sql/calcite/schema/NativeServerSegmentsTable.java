...
/** Native-query representation of {@code sys.server_segments}. */
class NativeServerSegmentsTable extends DruidTable
{
  private static final DataSource DATA_SOURCE = new SystemTableDataSource(
      ServerSegmentsTableDescriptor.TABLE_NAME
  );

  NativeServerSegmentsTable()
  {
    super(ServerSegmentsTableDescriptor.ROW_SIGNATURE);
  }

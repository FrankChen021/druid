...
public class SuperSorterTest
{
  ...
  public static class NonParameterizedCasesTest extends InitializedNullHandlingTest
  {
    ...
    public void testSingleEmptyInputChannel_fileStorage() throws Exception
    {
      ...
      JupiterAssertions.assertEquals(1, channels.getAllChannels().size());
      ...
      JupiterAssertions.assertEquals(1.0, superSorterProgressTracker.snapshot().getProgressDigest(), 0.0f);
      channel.close();
    }
  ...
  public static class ParameterizedCasesTest extends InitializedNullHandlingTest
  {
    ...
    ) throws Exception
    {
      ...
      JupiterAssertions.assertEquals(clusterByPartitions.size(), outputChannels.getAllChannels().size());
      JupiterAssertions.assertEquals(Double.valueOf(1.0), superSorterProgressTracker.snapshot().getProgressDigest());
    ...
    public void test_clusterByQualityDescRowNumberAsc_fourPartitions() throws Exception
    {
      ...
      JupiterAssertions.assertEquals(4, partitions.size());
  ...
  public static class CombinerTest extends InitializedNullHandlingTest
  {
    ...
    public void testCombineWithRowLimit() throws Exception
    {
      ...
      for (int limit = 1; limit <= 3; limit++) {
        ...
        JupiterAssertions.assertEquals(ImmutableList.of("a", 11L), rows.get(0));
        if (limit >= 2) {
          JupiterAssertions.assertEquals(ImmutableList.of("b", 22L), rows.get(1));
        }
        if (limit >= 3) {
          JupiterAssertions.assertEquals(ImmutableList.of("c", 33L), rows.get(2));
        }
      }
    }
    ...
    public void testCombineEmptyInput() throws Exception
    {
      ...
      JupiterAssertions.assertEquals(ImmutableList.of(), rows);
    }

...
public class FunctionTest extends InitializedNullHandlingTest
{
  ...
  public void testUnknownErrorsAreWrappedAndReported()
  {
    ...
    DruidException e = JupiterAssertions.assertThrows(
  ...
  public void testGreatest()
  {
    ...
    JupiterAssertions.assertEquals("Function[greatest] does not accept ARRAY<STRING> types", t.getMessage());
  ...
  public void testLeast()
  {
    ...
    JupiterAssertions.assertEquals("Function[least] does not accept ARRAY<LONG> types", t.getMessage());
  ...
  public void testSizeFormatInvalidArgumentSize()
  {
    ...
    JupiterAssertions.assertEquals("Function[human_readable_binary_byte_format] requires 1 or 2 arguments", t.getMessage());
  }
  ...
  public void testLeft()
  {
    ...
    Throwable t1 = JupiterAssertions.assertThrows(
        DruidException.class,
        () -> assertExpr("left('foo', -2)", null)
    );
    JupiterAssertions.assertEquals("Function[left] needs a positive integer as the second argument", t1.getMessage());
  }
  ...
  public void testRight()
  {
    ...
    JupiterAssertions.assertEquals("Function[right] needs a positive integer as the second argument", t1.getMessage());
  }
  ...
  public void testRepeat()
  {
    ...
    JupiterAssertions.assertEquals("Function[repeat] needs an integer as the second argument", t.getMessage());
  }
  ...
  public void testComplexDecode()
  {
    ...
    JupiterAssertions.assertEquals(bytes.length, written);
    assertExpr(
        StringUtils.format(
  ...
  public void testMacrosWithMultipleAliases()
  {
    ...
    JupiterAssertions.assertEquals(happiness, Parser.parse("drink(1,2)", exprMacroTable));
    for (String tea : aliases) {
      JupiterAssertions.assertEquals(happiness, Parser.parse(StringUtils.format("%s(1,2)", tea), exprMacroTable));
    }
  }
  ...
  public void testComplexDecodeBaseWrongArgCount()
  {
    ...
    JupiterAssertions.assertEquals("Function[complex_decode_base64] requires 2 arguments", t.getMessage());
  }
  ...
  )
  {
    ...
    JupiterAssertions.assertEquals(expression, expectedResult, expr.eval(bindings).value());
    ...
    JupiterAssertions.assertEquals(expr.stringify(), expectedResult, roundTrip.eval(bindings).value());

    final Expr roundTripFlatten = Parser.parse(expr.stringify(), macroTable);
    JupiterAssertions.assertEquals(expr.stringify(), expectedResult, roundTripFlatten.eval(bindings).value());

    final Expr singleThreaded = Expr.singleThreaded(expr, bindings);
    JupiterAssertions.assertEquals(singleThreaded.stringify(), expectedResult, singleThreaded.eval(bindings).value());
    ...
    JupiterAssertions.assertEquals(expr.stringify(), roundTrip.stringify());
    JupiterAssertions.assertEquals(expr.stringify(), roundTripFlatten.stringify());
    JupiterAssertions.assertArrayEquals(expr.getCacheKey(), roundTrip.getCacheKey());
    JupiterAssertions.assertArrayEquals(expr.getCacheKey(), roundTripFlatten.getCacheKey());
  }
  ...
  {
    final Expr expr = Parser.parse(expression, macroTable);
    JupiterAssertions.assertArrayEquals(expression, expectedResult, expr.eval(bindings).asArray());

    final Expr exprNoFlatten = Parser.parse(expression, macroTable, false);
    final Expr roundTrip = Parser.parse(exprNoFlatten.stringify(), macroTable);
    JupiterAssertions.assertArrayEquals(expression, expectedResult, roundTrip.eval(bindings).asArray());

    final Expr roundTripFlatten = Parser.parse(expr.stringify(), macroTable);
    JupiterAssertions.assertArrayEquals(expression, expectedResult, roundTripFlatten.eval(bindings).asArray());
  ...
  public void testNow()
  {
    ...
    JupiterAssertions.assertNotNull(result.value());
    JupiterAssertions.assertEquals(ExpressionType.LONG, result.type());
  ...
  public void testNowEvaluatedPerRow()
  {
    ...
    JupiterAssertions.assertNull(expr.getLiteralValue());
  ...
  public void testNowRejectsArguments()
  {
    ...
    JupiterAssertions.assertEquals("Function[now] does not accept arguments", t.getMessage());
  }

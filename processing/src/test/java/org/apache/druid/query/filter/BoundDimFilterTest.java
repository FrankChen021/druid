...
public class BoundDimFilterTest
{
  ...
  public void testSerDesBoundFilter() throws IOException
  {
    ...
    JupiterAssertions.assertEquals(boundDimFilter, actualBoundDimFilter);
  }
  ...
  public void testGetCacheKey()
  {
    ...
    JupiterAssertions.assertArrayEquals(boundDimFilter.getCacheKey(), boundDimFilterCopy.getCacheKey());
    ...
    JupiterAssertions.assertFalse(Arrays.equals(anotherBoundDimFilter.getCacheKey(), boundDimFilter.getCacheKey()));
    ...
    JupiterAssertions.assertFalse(Arrays.equals(boundDimFilter.getCacheKey(), boundDimFilterWithExtract.getCacheKey()));
    JupiterAssertions.assertArrayEquals(boundDimFilterWithExtract.getCacheKey(), boundDimFilterWithExtractCopy.getCacheKey());
  }
  ...
  public void testHashCode()
  {
    ...
    JupiterAssertions.assertNotEquals(boundDimFilter.hashCode(), boundDimFilterWithExtract.hashCode());
  }
  ...
  {
    BoundDimFilter boundDimFilter = new BoundDimFilter("dimension", "12", "15", null, null, true, null, StringComparators.ALPHANUMERIC);
    JupiterAssertions.assertEquals(boundDimFilter.getRequiredColumns(), Sets.newHashSet("dimension"));
  }
}

...
public class SegmentMetadataQueryQueryToolChestTest
{
  ...
  public void testCacheStrategy() throws Exception
  {
    ...
    JupiterAssertions.assertArrayEquals(expectedKey, actualKey);
    ...
    JupiterAssertions.assertEquals(result, fromCacheResult);
  }
  ...
  public void testMergeAggregators(AggregatorMergeStrategy aggregatorMergeStrategy)
  {
    ...
    final SegmentAnalysis expected = new SegmentAnalysis.Builder(
        ...
        .aggregator("baz", new DoubleSumAggregatorFactory("baz", "baz"))
        .build();
    JupiterAssertions.assertEquals(expected, mergeWithStrategy(analysis1, analysis2, aggregatorMergeStrategy));
  }
  ...
  public void testMergeAggregatorsOneNullStrict(AggregatorMergeStrategy aggregatorMergeStrategy)
  {
    ...
    JupiterAssertions.assertEquals(expectedNullAggregators, mergeWithStrategy(analysis1, analysis2, aggregatorMergeStrategy));
  }
  ...
  public void testMergeAggregatorsConflict()
  {
    ...
    final SegmentAnalysis expectedStrict = new SegmentAnalysis.Builder(
        "dummy_2021-01-01T00:00:00.000Z_2021-01-02T00:00:00.000Z_merged").build();
    JupiterAssertions.assertEquals(expectedStrict, mergeWithStrategy(analysis1, analysis2, AggregatorMergeStrategy.STRICT));
    ...
    final SegmentAnalysis expectedLenient = new SegmentAnalysis.Builder(
        ...
        .aggregator("baz", new LongMaxAggregatorFactory("baz", "baz"))
        .build();
    JupiterAssertions.assertEquals(expectedLenient, mergeLenient(analysis1, analysis2));
    ...
    JupiterAssertions.assertEquals(expectedLenient, mergeLenient(analysis1, mergeLenient(analysis1, analysis2)));
    // Simulate multi-level lenient merge (unmerged second)
    JupiterAssertions.assertEquals(expectedLenient, mergeLenient(mergeLenient(analysis1, analysis2), analysis1));
    ...
    final SegmentAnalysis expectedEarliest = new SegmentAnalysis.Builder(
        ...
        .aggregator("baz", new LongMaxAggregatorFactory("baz", "baz"))
        .build();
    JupiterAssertions.assertEquals(expectedEarliest, mergeEarliest(analysis1, analysis2));
    ...
    final SegmentAnalysis expectedLatest = new SegmentAnalysis.Builder(
        ...
        .aggregator("baz", new LongMaxAggregatorFactory("baz", "baz"))
        .build();
    JupiterAssertions.assertEquals(expectedLatest, mergeLatest(analysis1, analysis2));
  ...
  public void testFilterSegments()
  {
    ...
    JupiterAssertions.assertEquals(Period.weeks(1), config.getDefaultHistory());
    JupiterAssertions.assertEquals(
        ImmutableList.of(
  ...
  public void testMergeRollup(AggregatorMergeStrategy aggregatorMergeStrategy)
  {
    ...
    JupiterAssertions.assertNull(mergeWithStrategy(analysis1, analysis2, aggregatorMergeStrategy).isRollup());
    JupiterAssertions.assertNull(mergeWithStrategy(analysis1, analysis4, aggregatorMergeStrategy).isRollup());
    JupiterAssertions.assertNull(mergeWithStrategy(analysis2, analysis4, aggregatorMergeStrategy).isRollup());
    JupiterAssertions.assertFalse(mergeWithStrategy(analysis2, analysis3, aggregatorMergeStrategy).isRollup());
    JupiterAssertions.assertTrue(mergeWithStrategy(analysis4, analysis5, aggregatorMergeStrategy).isRollup());
  }
  ...
  public void testMergeWithNullAnalyses(AggregatorMergeStrategy aggregatorMergeStrategy)
  {
    ...
    JupiterAssertions.assertEquals(analysis1, mergeWithStrategy(analysis1, null, aggregatorMergeStrategy));
    JupiterAssertions.assertEquals(analysis2, mergeWithStrategy(null, analysis2, aggregatorMergeStrategy));
  ...
  public void testProjectionsWithNull(AggregatorMergeStrategy aggregatorMergeStrategy)
  {
    ...
    JupiterAssertions.assertNull(mergeWithStrategy(analysis1NullProjection, analysis2, aggregatorMergeStrategy).getProjections());
    JupiterAssertions.assertNull(mergeWithStrategy(analysis1, analysis2NullProjection, aggregatorMergeStrategy).getProjections());
    JupiterAssertions.assertNull(
  ...
  public void testProjectionsWithConflict(AggregatorMergeStrategy aggregatorMergeStrategy)
  {
    ...
    final SegmentAnalysis expectedStrict = new SegmentAnalysis.Builder(
        ...
        .projection("channel_sum", new AggregateProjectionMetadata(PROJECTION_CHANNEL_ADDED_HOURLY, 300))
        .build();
    JupiterAssertions.assertEquals(expectedStrict, mergeWithStrategy(analysis1, analysis2, aggregatorMergeStrategy));
  }

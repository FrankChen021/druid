...
public class IPv4AddressStringifyExprMacroTest extends MacroTestBase
{
  ...
  public void testNullLongArg()
  {
    ...
    JupiterAssertions.assertNull(eval(nullNumeric));
  }
  ...
  public void testInvalidLongArgTooSmall()
  {
    ...
    JupiterAssertions.assertNull(eval(tooSmall));
  }
  ...
  public void testValidLongArgLowest()
  {
    ...
    JupiterAssertions.assertEquals("0.0.0.0", eval(tooSmall));
  }
  ...
  public void testValidLongArgHighest()
  {
    ...
    JupiterAssertions.assertEquals("255.255.255.255", eval(tooSmall));
  }
  ...
  public void testInvalidLongArgTooLarge()
  {
    ...
    JupiterAssertions.assertNull(eval(tooLarge));
  }

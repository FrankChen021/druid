...
public class ImmutableConciseSetTest
{
  ...
  public void testWordIteratorNext1()
  {
    ...
    JupiterAssertions.assertEquals(0x8000003E, itr.next());

    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testWordIteratorNext2()
  {
    ...
    ImmutableConciseSet.WordIterator itr = iSet.newWordIterator();
    JupiterAssertions.assertEquals(0x40000C98, itr.next());
    JupiterAssertions.assertEquals(0x81FFFFFF, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testWordIteratorAdvanceTo1()
  {
    ...
    ImmutableConciseSet.WordIterator itr = iSet.newWordIterator();
    itr.advanceTo(50);
    JupiterAssertions.assertEquals(1073744998, itr.next());
    JupiterAssertions.assertEquals(0x81FFFFFF, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactOneLitOneLit()
  {
    ...
    JupiterAssertions.assertEquals(0x40000001, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactOneLitPureOneFill()
  {
    ...
    JupiterAssertions.assertEquals(0x40000005, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactOneLitDirtyOneFill()
  {
    ...
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(0x42000004, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactOneFillPureOneFill()
  {
    ...
    JupiterAssertions.assertEquals(0x40000009, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactOneFillDirtyOneFill()
  {
    ...
    JupiterAssertions.assertEquals(0x40000004, itr.next());
    JupiterAssertions.assertEquals(0x42000004, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactZeroLitZeroLit()
  {
    ...
    JupiterAssertions.assertEquals(0x00000001, itr.next());
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactZeroLitPureZeroFill()
  {
    ...
    JupiterAssertions.assertEquals(0x00000005, itr.next());
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactZeroLitDirtyZeroFill()
  {
    ...
    JupiterAssertions.assertEquals(0x80000000, itr.next());
    JupiterAssertions.assertEquals(0x02000004, itr.next());
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactZeroFillPureZeroFill()
  {
    ...
    JupiterAssertions.assertEquals(0x00000009, itr.next());
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactZeroFillDirtyZeroFill()
  {
    ...
    JupiterAssertions.assertEquals(0x00000004, itr.next());
    JupiterAssertions.assertEquals(0x02000004, itr.next());
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactSingleOneBitLitZeroLit()
  {
    ...
    JupiterAssertions.assertEquals(0x02000001, itr.next());
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactDoubleOneBitLitZeroLit()
  {
    ...
    JupiterAssertions.assertEquals(0x80000003, itr.next());
    JupiterAssertions.assertEquals(0x80000000, itr.next());
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactSingleOneBitLitPureZeroFill()
  {
    ...
    JupiterAssertions.assertEquals(0x02000005, itr.next());
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactSingleOneBitLitDirtyZeroFill()
  {
    ...
    JupiterAssertions.assertEquals(0x80000001, itr.next());
    JupiterAssertions.assertEquals(0x02000004, itr.next());
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactSingleZeroBitLitOneLit()
  {
    ...
    JupiterAssertions.assertEquals(0x42000001, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactDoubleZeroBitLitOneLit()
  {
    ...
    JupiterAssertions.assertEquals(0xFFFFFFEE, itr.next());
    JupiterAssertions.assertEquals(-1, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactSingleZeroBitLitPureOneFill()
  {
    ...
    JupiterAssertions.assertEquals(0x42000005, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactDoubleZeroBitLitPureOneFill()
  {
    ...
    JupiterAssertions.assertEquals(0xFFFFFFFC, itr.next());
    JupiterAssertions.assertEquals(0x40000004, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactSingleZeroBitLitDirtyOneFill()
  {
    ...
    JupiterAssertions.assertEquals(0xFFFFFFFE, itr.next());
    JupiterAssertions.assertEquals(0x42000004, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testCompactTwoLiterals()
  {
    ...
    JupiterAssertions.assertEquals(0xFFFFFFFE, itr.next());
    JupiterAssertions.assertEquals(0xFFEFFEFF, itr.next());
    JupiterAssertions.assertEquals(itr.hasNext(), false);
  }
  ...
  public void testComplement9()
  {
    ...
    for (final int length : lengths) {
      ...
      for (int i = 0; i < length; i++) {
        ...
        if (i != n) {
          JupiterAssertions.assertEquals(StringUtils.format("Failure at bit [%d] on length [%d]", i, length), i, n);
        }
      }
  ...
  public void testContains()
  {
    ...
    for (int i = 0; i < max + 10; ++i) {
      ...
      JupiterAssertions.assertEquals(s, integerSet.contains(i), conciseSet.contains(i));
      JupiterAssertions.assertEquals(s, integerSet.contains(i), immutableConciseSet.contains(i));
    }
  }
}

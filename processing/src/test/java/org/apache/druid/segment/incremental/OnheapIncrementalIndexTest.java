...
public class OnheapIncrementalIndexTest
{
  ...
  public void testSpecSerde() throws JsonProcessingException
  {
    ...
    JupiterAssertions.assertEquals(spec, MAPPER.readValue(MAPPER.writeValueAsString(spec), OnheapIncrementalIndex.Spec.class));
  }
  ...
  public void testProjectionHappyPath()
  {
    ...
    JupiterAssertions.assertNotNull(index.getProjection("proj"));
  }
  ...
  public void testProjectionDuplicatedName()
  {
    ...
    JupiterAssertions.assertEquals(DruidException.Category.DEFENSIVE, e.getCategory());
    JupiterAssertions.assertEquals("duplicate projection[proj]", e.getMessage());
  }
  ...
  public void testTimestampOutOfRange()
  {
    ...
    JupiterAssertions.assertTrue(addResult.isRowAdded());

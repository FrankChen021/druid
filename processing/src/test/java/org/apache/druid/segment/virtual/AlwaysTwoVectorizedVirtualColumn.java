...
public class AlwaysTwoVectorizedVirtualColumn implements VirtualColumn
{
  ...
  {
    JupiterAssertions.assertNotNull(inspector);
    return canVectorize;
  }
  ...
  {
    JupiterAssertions.assertEquals(outputName, dimensionSpec.getOutputName());
  ...
  {
    JupiterAssertions.assertEquals(outputName, columnName);

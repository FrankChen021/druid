...
public class BitmapOffsetTest
{
  ...
  public void testSanity()
  {
    ...
    while (offset.withinBounds()) {
      JupiterAssertions.assertEquals(expected[count], offset.getOffset());

      int cloneCount = count;
      Offset clonedOffset = offset.clone();
      while (clonedOffset.withinBounds()) {
        JupiterAssertions.assertEquals(expected[cloneCount], clonedOffset.getOffset());
    ...
    JupiterAssertions.assertEquals(count, expected.length);
  }
}

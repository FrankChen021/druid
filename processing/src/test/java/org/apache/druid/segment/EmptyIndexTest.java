...
public class EmptyIndexTest
{
  ...
  public void testEmptyIndex() throws Exception
  {
    ...
    try {
      ...
      JupiterAssertions.assertEquals("getDimensionNames", 0, Iterables.size(emptyQueryableIndex.getAvailableDimensions()));
      JupiterAssertions.assertEquals("getMetricNames", 0, emptyQueryableIndex.getColumnNames().size());
      JupiterAssertions.assertEquals("getDataInterval", Intervals.of("2012-08-01/P3D"), emptyQueryableIndex.getDataInterval());

...
public class IncrementalIndexTest extends InitializedNullHandlingTest
{
  ...
  public void testUnparseableNumerics()
  {
    ...
    JupiterAssertions.assertEquals(UnparseableColumnsParseException.class, result.getParseException().getClass());
  ...
  public void sameRow()
  {
    ...
    JupiterAssertions.assertEquals("rollup".equals(mode) ? 1 : 3, index.numRows());
  }
  ...
  public void testTypeHandling()
  {
    ...
    JupiterAssertions.assertNull(result.getParseException());
    result = index.add(
        new MapBasedInputRow(
    ...
    JupiterAssertions.assertEquals(ColumnType.STRING, index.getColumnCapabilities("string").toColumnType());
    JupiterAssertions.assertEquals(ColumnType.FLOAT, index.getColumnCapabilities("float").toColumnType());
    JupiterAssertions.assertEquals(ColumnType.LONG, index.getColumnCapabilities("long").toColumnType());
    JupiterAssertions.assertEquals(ColumnType.DOUBLE, index.getColumnCapabilities("double").toColumnType());
    JupiterAssertions.assertEquals(ColumnType.STRING, index.getColumnCapabilities("bool_string").toColumnType());
    JupiterAssertions.assertEquals(ColumnType.LONG, index.getColumnCapabilities("bool_long").toColumnType());
    JupiterAssertions.assertEquals(ColumnType.LONG, index.getColumnCapabilities("bool_auto").toColumnType());
    JupiterAssertions.assertEquals(ColumnType.STRING_ARRAY, index.getColumnCapabilities("array_string").toColumnType());
    JupiterAssertions.assertEquals(ColumnType.LONG_ARRAY, index.getColumnCapabilities("array_long").toColumnType());
    JupiterAssertions.assertEquals(ColumnType.DOUBLE_ARRAY, index.getColumnCapabilities("array_double").toColumnType());
    JupiterAssertions.assertEquals(ColumnType.NESTED_DATA, index.getColumnCapabilities("nested").toColumnType());


    Iterator<Row> rowIterator = index.iterator();
    Row row = rowIterator.next();
    JupiterAssertions.assertEquals("a", row.getRaw("string"));
    JupiterAssertions.assertEquals(1.0f, row.getRaw("float"));
    JupiterAssertions.assertEquals(1L, row.getRaw("long"));
    JupiterAssertions.assertEquals(1.0, row.getRaw("double"));
    JupiterAssertions.assertEquals("true", row.getRaw("bool_string"));
    JupiterAssertions.assertEquals(1L, row.getRaw("bool_long"));
    JupiterAssertions.assertEquals(StructuredData.wrap(true), row.getRaw("bool_auto"));
    JupiterAssertions.assertEquals(StructuredData.wrap(new Object[]{"a", "b", "c"}), row.getRaw("array_string"));
    JupiterAssertions.assertEquals(StructuredData.wrap(new Object[]{1L, 2L, 3L}), row.getRaw("array_long"));
    JupiterAssertions.assertEquals(StructuredData.wrap(new Object[]{1.1, 2.2, 3.3}), row.getRaw("array_double"));
    JupiterAssertions.assertEquals(StructuredData.wrap(ImmutableMap.of("x", 1, "y", ImmutableList.of("a", "b"))), row.getRaw("nested"));

    row = rowIterator.next();
    JupiterAssertions.assertEquals("b", row.getRaw("string"));
    JupiterAssertions.assertEquals(2.0f, row.getRaw("float"));
    JupiterAssertions.assertEquals(2L, row.getRaw("long"));
    JupiterAssertions.assertEquals(2.0, row.getRaw("double"));
    JupiterAssertions.assertEquals("false", row.getRaw("bool_string"));
    JupiterAssertions.assertEquals(0L, row.getRaw("bool_long"));
    JupiterAssertions.assertEquals(StructuredData.wrap(false), row.getRaw("bool_auto"));
    JupiterAssertions.assertEquals(StructuredData.wrap(new Object[]{"d", "e", "f"}), row.getRaw("array_string"));
    JupiterAssertions.assertEquals(StructuredData.wrap(new Object[]{4L, 5L, 6L}), row.getRaw("array_long"));
    JupiterAssertions.assertEquals(StructuredData.wrap(new Object[]{4.4, 5.5, 6.6}), row.getRaw("array_double"));
    JupiterAssertions.assertEquals(StructuredData.wrap(ImmutableMap.of("x", 2, "y", ImmutableList.of("c", "d"))), row.getRaw("nested"));
  }
}

...
public class FallbackVirtualColumnTest
{
  ...
  {
    JupiterAssertions.assertEquals("slimshady", makeCol("slimshady", "test1", "test2").getOutputName());
  }
  ...
  public void testMakeDimensionSelector()
  {
    ...
    JupiterAssertions.assertSame(colA, col.makeDimensionSelector(new IgnoredDimensionSpec(), selectorFactory));

    selectorFactory.addCapabilities("colA", null);
    JupiterAssertions.assertSame(colB, col.makeDimensionSelector(new IgnoredDimensionSpec(), selectorFactory));

    selectorFactory.addCapabilities("colB", null);
    JupiterAssertions.assertSame(colC, col.makeDimensionSelector(new IgnoredDimensionSpec(), selectorFactory));
  ...
  public void testMakeColumnValueSelector()
  {
    ...
    JupiterAssertions.assertSame(colA, col.makeColumnValueSelector("abcd", selectorFactory));

    selectorFactory.addCapabilities("colA", null);
    JupiterAssertions.assertSame(colB, col.makeColumnValueSelector("abcd", selectorFactory));

    selectorFactory.addCapabilities("colB", null);
    JupiterAssertions.assertSame(colC, col.makeColumnValueSelector("abcd", selectorFactory));
  ...
  {
    JupiterAssertions.assertTrue(makeCol("slimshady", "test1").canVectorize(null));
  }
  ...
  public void testMakeSingleValueVectorDimensionSelector()
  {
    ...
    JupiterAssertions.assertSame(colA, col.makeSingleValueVectorDimensionSelector(new IgnoredDimensionSpec(), selectorFactory));

    selectorFactory.addCapabilities("colA", null);
    JupiterAssertions.assertSame(colB, col.makeSingleValueVectorDimensionSelector(new IgnoredDimensionSpec(), selectorFactory));

    selectorFactory.addCapabilities("colB", null);
    JupiterAssertions.assertSame(colC, col.makeSingleValueVectorDimensionSelector(new IgnoredDimensionSpec(), selectorFactory));
  ...
  public void testMakeMultiValueVectorDimensionSelector()
  {
    ...
    JupiterAssertions.assertSame(colA, col.makeMultiValueVectorDimensionSelector(new IgnoredDimensionSpec(), selectorFactory));

    selectorFactory.addCapabilities("colA", null);
    JupiterAssertions.assertSame(colB, col.makeMultiValueVectorDimensionSelector(new IgnoredDimensionSpec(), selectorFactory));

    selectorFactory.addCapabilities("colB", null);
    JupiterAssertions.assertSame(colC, col.makeMultiValueVectorDimensionSelector(new IgnoredDimensionSpec(), selectorFactory));
  ...
  public void testMakeVectorValueSelector()
  {
    ...
    JupiterAssertions.assertSame(colA, col.makeVectorValueSelector("abcd", selectorFactory));

    selectorFactory.addCapabilities("colA", null);
    JupiterAssertions.assertSame(colB, col.makeVectorValueSelector("abcd", selectorFactory));

    selectorFactory.addCapabilities("colB", null);
    JupiterAssertions.assertSame(colC, col.makeVectorValueSelector("abcd", selectorFactory));
  ...
  public void testMakeVectorObjectSelector()
  {
    ...
    JupiterAssertions.assertSame(colA, col.makeVectorObjectSelector("abcd", selectorFactory));

    selectorFactory.addCapabilities("colA", null);
    JupiterAssertions.assertSame(colB, col.makeVectorObjectSelector("abcd", selectorFactory));

    selectorFactory.addCapabilities("colB", null);
    JupiterAssertions.assertSame(colC, col.makeVectorObjectSelector("abcd", selectorFactory));
  ...
  public void testCapabilities()
  {
    ...
    JupiterAssertions.assertEquals(ColumnCapabilitiesImpl.createDefault().getType(), col.capabilities("abcd").getType());

    JupiterAssertions.assertSame(colA, col.capabilities(selectorFactory, "abcd"));

    selectorFactory.addCapabilities("colA", null);
    JupiterAssertions.assertSame(colB, col.capabilities(selectorFactory, "abcd"));

    selectorFactory.addCapabilities("colB", null);
    JupiterAssertions.assertSame(colC, col.capabilities(selectorFactory, "abcd"));

    selectorFactory.addCapabilities("colC", null);
    JupiterAssertions.assertNull(col.capabilities(selectorFactory, "abcd"));
  }
  ...
  {
    JupiterAssertions.assertFalse(makeCol("hi", "my", "name", "is").usesDotNotation());
  }
  ...
  public void testGetIndexSupplier() throws IOException
  {
    ...
    try (final Closer closer = Closer.create()) {
      ...
      JupiterAssertions.assertSame(colA, col.getIndexSupplier("abcd", columnIndexSelector));
    }

    Mockito.when(testIndex.getColumnHolder("colA")).thenReturn(new HolderForIndexSupplier(colA, null));
    try (final Closer closer = Closer.create()) {
      final ColumnIndexSelector columnIndexSelector = new ColumnCache(testIndex, VirtualColumns.EMPTY, closer);
      JupiterAssertions.assertSame(colB, col.getIndexSupplier("abcd", columnIndexSelector));
    }

    Mockito.when(testIndex.getColumnHolder("colB")).thenReturn(new HolderForIndexSupplier(colB, null));
    try (final Closer closer = Closer.create()) {
      final ColumnIndexSelector columnIndexSelector = new ColumnCache(testIndex, VirtualColumns.EMPTY, closer);
      JupiterAssertions.assertSame(colC, col.getIndexSupplier("abcd", columnIndexSelector));
    }

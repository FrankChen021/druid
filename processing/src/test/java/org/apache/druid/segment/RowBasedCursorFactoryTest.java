...
public class RowBasedCursorFactoryTest
{
  ...
  public void test_getRowSignature()
  {
    ...
    JupiterAssertions.assertEquals(ROW_SIGNATURE, adapter.getRowSignature());
  }
  ...
  public void test_getColumnCapabilities_float()
  {
    ...
    JupiterAssertions.assertEquals(ValueType.FLOAT, capabilities.getType());
  ...
  public void test_getColumnCapabilities_double()
  {
    ...
    JupiterAssertions.assertEquals(ValueType.DOUBLE, capabilities.getType());
    JupiterAssertions.assertFalse(capabilities.hasMultipleValues().isMaybeTrue());
  }
  ...
  public void test_getColumnCapabilities_string()
  {
    ...
    JupiterAssertions.assertTrue(capabilities.hasMultipleValues().isUnknown());
  }
  ...
  public void test_getColumnCapabilities_complex()
  {
    ...
    JupiterAssertions.assertEquals(ColumnType.UNKNOWN_COMPLEX, capabilities.toColumnType());
    JupiterAssertions.assertFalse(capabilities.hasMultipleValues().isTrue());
    JupiterAssertions.assertTrue(capabilities.isDictionaryEncoded().isUnknown());
  }
  ...
  {
    final RowBasedCursorFactory<Integer> adapter = createIntAdapter(0, 1, 2);
    JupiterAssertions.assertNull(adapter.getColumnCapabilities("nonexistent"));
  }
  ...
  public void test_getColumnTypeString()
  {
    ...
    for (String columnName : ROW_SIGNATURE.getColumnNames()) {
      if (UNKNOWN_TYPE_NAME.equals(columnName)) {
        JupiterAssertions.assertNull(columnName, adapter.getColumnCapabilities(columnName));
      } else {
  ...
  public void test_makeCursor()
  {
    ...
    JupiterAssertions.assertEquals(2, numCloses.get());
  }
  ...
  public void test_makeCursor_descending()
  {
    ...
    JupiterAssertions.assertEquals(1, numCloses.get());
  }

    ...
    public void aggregate(ByteBuffer buf, int position, int startRow, int endRow)
    {
      if (valueSelector != null) {
        ...
        for (int i = startRow; i < endRow; i++) {
          JupiterAssertions.assertEquals(2L, vector[i]);
          count += 1;
        }
      ...
      if (objectSelector != null) {
        ...
        for (int i = startRow; i < endRow; i++) {
          if (vector[i] instanceof List) {
            JupiterAssertions.assertEquals(ImmutableList.of("2", "2"), vector[i]);
            count += 2;
          } else {
            JupiterAssertions.assertEquals("2", vector[i]);
            count += 1;
          }
        }
      ...
      if (singleValueDimensionSelector != null) {
        ...
        long count = 0;
        for (int i = startRow; i < endRow; i++) {
          JupiterAssertions.assertEquals("2", singleValueDimensionSelector.lookupName(rowVector[i]));
          count += 1;
        }
      ...
      if (multiValueDimensionSelector != null) {
        ...
        for (int i = startRow; i < endRow; i++) {
          ...
          for (int j = 0; j < rowVector[i].size(); j++) {
            JupiterAssertions.assertEquals("2", multiValueDimensionSelector.lookupName(rowVector[i].get(j)));
            count += 1;
          }
        }

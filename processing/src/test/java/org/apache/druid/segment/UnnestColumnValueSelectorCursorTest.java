...
public class UnnestColumnValueSelectorCursorTest extends InitializedNullHandlingTest
{
  ...
  public void test_list_unnest_cursors()
  {
    ...
    while (!unnestCursor.isDone()) {
      ...
      JupiterAssertions.assertEquals(String.valueOf(j), colSelectorVal.toString());
      j++;
      unnestCursor.advance();
    }
    JupiterAssertions.assertEquals(j, 4);
  }
  ...
  public void test_list_unnest_cursors_user_supplied_list()
  {
    ...
    while (!unnestCursor.isDone()) {
      ...
      JupiterAssertions.assertEquals(expectedResults.get(k), valueSelectorVal.toString());
      k++;
      unnestCursor.advance();
    }
    JupiterAssertions.assertEquals(k, 9);
  }
  ...
  public void test_list_unnest_cursors_user_supplied_list_only_nulls()
  {
    ...
    JupiterAssertions.assertEquals(k, 2);
  }
  ...
  public void test_list_unnest_cursors_user_supplied_list_only_nulls_array()
  {
    ...
    JupiterAssertions.assertEquals(k, 4);
  }
  ...
  public void test_list_unnest_cursors_user_supplied_list_mixed_with_nulls()
  {
    ...
    while (!unnestCursor.isDone()) {
      ...
      if (valueSelectorVal == null) {
        JupiterAssertions.assertNull(expectedResults.get(k));
      } else {
        JupiterAssertions.assertEquals(expectedResults.get(k), valueSelectorVal.toString());
      }
      k++;
    ...
    JupiterAssertions.assertEquals(k, 7);
  }
  ...
  public void test_list_unnest_cursors_user_supplied_list_mixed_with_nulls_array()
  {
    ...
    JupiterAssertions.assertEquals(k, 8);
  }
  ...
  public void test_list_unnest_cursors_user_supplied_lists_three_levels()
  {
    ...
    while (!unnestCursor.isDone()) {
      Object valueSelectorVal = unnestColumnValueSelector.getObject();
      JupiterAssertions.assertEquals(expectedResults.get(k).toString(), valueSelectorVal.toString());
      k++;
      unnestCursor.advance();
    }
    JupiterAssertions.assertEquals(k, 10);
  }
  ...
  public void test_list_unnest_of_unnest_cursors_user_supplied_list_three_levels()
  {
    ...
    JupiterAssertions.assertEquals(k, 11);
  }
  ...
  public void test_list_unnest_cursors_user_supplied_list_with_nulls()
  {
    ...
    while (!unnestCursor.isDone()) {
      Object valueSelectorVal = unnestColumnValueSelector.getObject();
      if (valueSelectorVal == null) {
        JupiterAssertions.assertEquals(null, expectedResults.get(k));
      } else {
        JupiterAssertions.assertEquals(expectedResults.get(k), valueSelectorVal.toString());
      }
      k++;
    ...
    JupiterAssertions.assertEquals(expectedResults.size(), k);
  }
  ...
  public void test_list_unnest_cursors_user_supplied_list_double()
  {
    ...
    while (!unnestCursor.isDone()) {
      ...
      JupiterAssertions.assertEquals(expectedResults.get(k), valueSelectorVal);
      k++;
      unnestCursor.advance();
    }
    JupiterAssertions.assertEquals(k, 9);
  ...
  public void test_list_unnest_cursors_user_supplied_list_long()
  {
    ...
    while (!unnestCursor.isDone()) {
      ...
      JupiterAssertions.assertNotNull(obj);
  ...
  public void test_list_unnest_cursors_user_supplied_list_three_level_arrays_and_methods()
  {
    ...
    JupiterAssertions.assertEquals(k, 10);
    unnestCursor.reset();
    JupiterAssertions.assertFalse(unnestCursor.isDoneOrInterrupted());
  }
  ...
  public void test_list_unnest_cursors_dimSelector()
  {
    ...
    while (!unnestCursor.isDone()) {
      if (k < 8) {
        JupiterAssertions.assertEquals(expectedResults.get(k).toString(), unnestDimSelector.getValue());
      } else {
        JupiterAssertions.assertNull(unnestDimSelector.getValue());
      }
      k++;
      unnestCursor.advance();
    }
    JupiterAssertions.assertEquals(k, 8);
    unnestCursor.reset();
    JupiterAssertions.assertNotNull(unnestDimSelector);
  }

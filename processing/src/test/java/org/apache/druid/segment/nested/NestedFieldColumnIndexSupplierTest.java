...
public class NestedFieldColumnIndexSupplierTest extends InitializedNullHandlingTest
{
  ...
  public void testSingleTypeStringColumnValueIndex() throws IOException
  {
    ...
    JupiterAssertions.assertNotNull(nullIndex);

    // sanity check to make sure we don't return indexes we don't support
    JupiterAssertions.assertNull(indexSupplier.as(SpatialIndex.class));
    ...
    JupiterAssertions.assertNotNull(columnIndex);
  ...
  public void testSingleTypeStringColumnValueSetIndex() throws IOException
  {
    ...
    JupiterAssertions.assertNotNull(valueSetIndex);
  ...
  public void testSingleTypeStringColumnRangeIndex() throws IOException
  {
    ...
    JupiterAssertions.assertNotNull(rangeIndex);
    ...
    JupiterAssertions.assertNotNull(forRange);
  ...
  public void testSingleTypeStringColumnPredicateIndex() throws IOException
  {
    ...
    JupiterAssertions.assertNotNull(predicateIndex);
  ...
  public void testSingleTypeLongColumnRangeIndex() throws IOException
  {
    ...
    JupiterAssertions.assertNotNull(rangeIndexes);
  ...
  public void testVariantRangeIndex() throws IOException
  {
    ...
    LexicographicalRangeIndexes rangeIndex = indexSupplier.as(LexicographicalRangeIndexes.class);
    JupiterAssertions.assertNull(rangeIndex);

    NumericRangeIndexes numericRangeIndexes = indexSupplier.as(NumericRangeIndexes.class);
    JupiterAssertions.assertNull(numericRangeIndexes);
  }
  ...
  public void testDictionaryEncodedStringValueIndex() throws IOException
  {
    ...
    JupiterAssertions.assertNotNull(lowLevelIndex);
    JupiterAssertions.assertNotNull(indexSupplier.as(DictionaryEncodedValueIndex.class));

    // 10 rows
    // local: [null, b, z, 1, 300, 1.1, 9.9]
    // column: [1, b, null, 9.9, 300, 1, z, null, 1.1, b]

    JupiterAssertions.assertNull(lowLevelIndex.getValue(0));
    JupiterAssertions.assertEquals("b", lowLevelIndex.getValue(1));
    JupiterAssertions.assertEquals("z", lowLevelIndex.getValue(2));
    JupiterAssertions.assertEquals("1", lowLevelIndex.getValue(3));
    JupiterAssertions.assertEquals("300", lowLevelIndex.getValue(4));
    JupiterAssertions.assertEquals("1.1", lowLevelIndex.getValue(5));
    JupiterAssertions.assertEquals("9.9", lowLevelIndex.getValue(6));

    JupiterAssertions.assertEquals(7, lowLevelIndex.getCardinality());
  ...
  void checkBitmap(ImmutableBitmap bitmap, int... expectedRows)
  {
    ...
    for (int i : expectedRows) {
      ...
      JupiterAssertions.assertEquals(i, iterator.next());
    }

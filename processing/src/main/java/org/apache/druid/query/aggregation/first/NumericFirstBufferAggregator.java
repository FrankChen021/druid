    ...
    implements BufferAggregator
{
  ...
  public NumericFirstBufferAggregator(BaseLongColumnValueSelector timeSelector, BaseObjectColumnValueSelector<?> valueSelector)
  {
  ...
  public void aggregate(ByteBuffer buf, int position)
  {
    ...
    if (time < firstTime) {
      ...
      if (useDefault || obj != null) {
        updateTimeWithValue(buf,
                            position,
                            time,
                            obj instanceof SerializablePair ? ((SerializablePair) obj).getRhs() : obj);
      } else {

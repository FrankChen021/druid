...
public class IndexerFrameContextTest
{
  ...
  public void test_acquireProcessingBuffers_alreadyAcquired_throws()
  {
    ...
    JUnitAssertions.assertEquals("Processing buffers already acquired", e.getMessage());
  ...
  public void test_processingBuffers_notAcquired_throws()
  {
    ...
    JUnitAssertions.assertEquals("Processing buffers not yet acquired", e.getMessage());
  }
  ...
  public void test_processingBuffers_afterAcquire_returnsBuffers()
  {
    ...
    JUnitAssertions.assertNotNull(buffers);
    JUnitAssertions.assertNotNull(buffers.getBufferPool());
    JUnitAssertions.assertNotNull(buffers.getBouncer());
  ...
  private static IndexerFrameContext makeContext(final ProcessingBuffersSet processingBuffersSet)
  {

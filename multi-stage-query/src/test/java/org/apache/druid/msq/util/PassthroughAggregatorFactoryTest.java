...
public class PassthroughAggregatorFactoryTest
{
  ...
  public void testSerde() throws JsonProcessingException
  {
    ...
    JUnitAssertions.assertEquals(aggregatorFactory, objectMapper.readValue(serializedvalue, AggregatorFactory.class));
  }
  ...
  public void testGetMergingFactoryOk() throws AggregatorFactoryNotMergeableException
  {
    ...
    JUnitAssertions.assertEquals(new PassthroughAggregatorFactory("x", "y"), mergingFactory);
  }

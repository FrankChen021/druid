...
public class NonShufflingWorkersWithRetryKernelTest extends BaseControllerQueryKernelTest
{
  ...
  public void testWorkerFailedAfterInitialization()
  {
    ...
    JUnitAssertions.assertTrue(controllerQueryKernelTester.createAndGetNewStageNumbers().size() == 1
                      && controllerQueryKernelTester.createAndGetNewStageNumbers().contains(0));
    JUnitAssertions.assertTrue(controllerQueryKernelTester.getRetriableWorkOrdersAndChangeState(0, RETRIABLE_FAULT).size() == 0);
  ...
  public void testWorkerFailedBeforeAnyResultsRecieved()
  {
    ...
    JUnitAssertions.assertTrue(controllerQueryKernelTester.createAndGetNewStageNumbers().size() == 0);
  ...
  public void testWorkerFailedBeforeFinished()
  {
    ...
    JUnitAssertions.assertEquals(0, controllerQueryKernelTester.getRetriableWorkOrdersAndChangeState(0, RETRIABLE_FAULT).size());
    JUnitAssertions.assertEquals(0, controllerQueryKernelTester.getRetriableWorkOrdersAndChangeState(1, RETRIABLE_FAULT).size());
  ...
  public void testMultipleWorkersFailedAfterInitialization()
  {
    ...
    JUnitAssertions.assertTrue(controllerQueryKernelTester.createAndGetNewStageNumbers().size() == 1
                      && controllerQueryKernelTester.createAndGetNewStageNumbers().contains(0));
    JUnitAssertions.assertTrue(controllerQueryKernelTester.getRetriableWorkOrdersAndChangeState(0, RETRIABLE_FAULT).size() == 0);
    JUnitAssertions.assertTrue(controllerQueryKernelTester.getRetriableWorkOrdersAndChangeState(1, RETRIABLE_FAULT).size() == 0);
    controllerQueryKernelTester.assertStagePhase(0, ControllerStagePhase.NEW);
    JUnitAssertions.assertTrue(controllerQueryKernelTester.createAndGetNewStageNumbers().size() == 1
                      && controllerQueryKernelTester.createAndGetNewStageNumbers().contains(0));
  }

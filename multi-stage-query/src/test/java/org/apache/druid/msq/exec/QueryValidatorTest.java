...
import static org.apache.druid.msq.test.JUnitAssertions.assertTrue;
...
public class QueryValidatorTest
{
  ...
  public void testNegativeWorkers()
  {
    Throwable exception = assertThrows(ISE.class, () ->
      QueryValidator.validateQueryDef(createQueryDefinition(1, -1)));
    assertTrue(exception.getMessage().contains("Number of workers must be greater than 0"));
  }
  ...
  {
    Throwable exception = assertThrows(MSQException.class, () ->

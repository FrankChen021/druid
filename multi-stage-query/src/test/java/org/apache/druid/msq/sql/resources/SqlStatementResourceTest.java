...
public class SqlStatementResourceTest extends MSQTestBase
{
  ...
  {
    JUnitAssertions.assertEquals(expectectedStatus.getStatusCode(), response.getStatus());
    JUnitAssertions.assertEquals(exceptionMessage, getQueryExceptionFromResponse(response));
  }
  ...
  public void testFinishedSelectMSQQuery() throws Exception
  {
    ...
    JUnitAssertions.assertEquals(Response.Status.OK.getStatusCode(), response.getStatus());
    JUnitAssertions.assertEquals(objectMapper.writeValueAsString(new SqlStatementResult(
        FINISHED_SELECT_MSQ_QUERY,
    ...
    JUnitAssertions.assertNull(getHeader(resultsResponse, SqlStatementResource.CONTENT_DISPOSITION_RESPONSE_HEADER));
  ...
  public void testDownloadResultsAsFile() throws Exception
  {
    ...
    JUnitAssertions.assertEquals(Response.Status.OK.getStatusCode(), resultsResponse1.getStatus());
    JUnitAssertions.assertEquals(
    ...
    JUnitAssertions.assertEquals(Response.Status.OK.getStatusCode(), resultsResponse2.getStatus());
    JUnitAssertions.assertEquals(
    ...
    JUnitAssertions.assertEquals(Response.Status.BAD_REQUEST.getStatusCode(), resultsResponse3.getStatus());
    JUnitAssertions.assertNull(resultsResponse3.getMetadata().get("Content-Disposition"));
  }
  ...
  public void testFinishedInsertMSQQuery()
  {
    ...
    JUnitAssertions.assertNull(getHeader(resultResponse, SqlStatementResource.CONTENT_DISPOSITION_RESPONSE_HEADER));
    JUnitAssertions.assertEquals(
        Response.Status.OK.getStatusCode(),
  ...
  {
    JUnitAssertions.assertEquals(Response.Status.OK.getStatusCode(), resource.isEnabled(makeOkRequest()).getStatus());
  }
  ...
  {
    assertThat(
        JUnitAssertions.assertThrows(DruidException.class, () -> SqlStatementResource.validateFilename(filename)),
        DruidExceptionAssertions.invalidInput().expectMessageIs(errorMessage)
    );
  }
}

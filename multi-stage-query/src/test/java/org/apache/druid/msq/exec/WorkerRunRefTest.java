...
public class WorkerRunRefTest
{
  ...
  public void testInterruptionOfLongRunningWorker() throws Exception
  {
    ...
    JUnitAssertions.assertTrue("Future should be done", future.isDone());
    JUnitAssertions.assertFalse("Future should not be canceled", future.isCancelled());
    JUnitAssertions.assertTrue("Worker should have been interrupted", wasInterrupted.get());
  ...
  public void testCancelBeforeRun()
  {
    ...
    JUnitAssertions.assertEquals(1, workerStarted.getCount());
  }
  ...
  public void testCancelCallsStop() throws Exception
  {
    ...
    JUnitAssertions.assertTrue(stopCalled.get());
  }
  ...
  public void testCancelBeforeRunDoesNotCallStop()
  {
    ...
    JUnitAssertions.assertFalse(stopCalled.get());
  }

...
public class ResultSetInformationTest
{
  ...
  {
    JUnitAssertions.assertEquals(JSON_STRING, MAPPER.writeValueAsString(RESULTS));
    JUnitAssertions.assertEquals(RESULTS, MAPPER.readValue(MAPPER.writeValueAsString(RESULTS), ResultSetInformation.class));
  ...
  public void resultsSanityTest() throws JsonProcessingException
  {
    ...
    JUnitAssertions.assertEquals(JSON_STRING_1, MAPPER.writeValueAsString(RESULTS_1));
  }

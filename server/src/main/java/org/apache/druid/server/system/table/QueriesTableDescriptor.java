...
/** Descriptor for the native {@code sys.queries} table. */
public class QueriesTableDescriptor implements SystemTableDescriptor
{
  ...
  private static final Set<NodeRole> NODE_ROLES = Set.of(
      NodeRole.BROKER,
      NodeRole.HISTORICAL,
      NodeRole.OVERLORD,
      NodeRole.PEON,
